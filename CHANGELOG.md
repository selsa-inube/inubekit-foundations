...
- docs: update readme with info about installing fonts
- fix: remove dist/ before build in pre-commit
...
- chore: add checkbox tokens to design system

---

# v5.11.0 (Mon Sep 02 2024)

- Add `Checkbox` Tokens to Design System [#90](https://github.com/selsa-inube/inubekit-foundations/pull/90)

---

# v5.10.0 (Fri Aug 30 2024)

- Add `RadioField` Tokens to Design System [#89](https://github.com/selsa-inube/inubekit-foundations/pull/89)

---

# v5.9.0 (Thu Aug 29 2024)

- Add ProgressBar Tokens to Update Design System [#88](https://github.com/selsa-inube/inubekit-foundations/pull/88)
...
- Update input tokens in foundations [#87](https://github.com/selsa-inube/inubekit-foundations/pull/87)

---

# v5.7.0 (Tue Aug 20 2024)

- Add Menu Tokens to Foundations [#86](https://github.com/selsa-inube/inubekit-foundations/pull/86)

---

# v5.6.1 (Fri Aug 02 2024)

- Update dispatch-update.yml in order to include button

---

# v5.6.0 (Fri Aug 02 2024)

- Update dispatch-update.yml [#85](https://github.com/selsa-inube/inubekit-foundations/pull/85)
...
- Update README.md [#84](https://github.com/selsa-inube/inubekit-foundations/pull/84)

---

# v5.4.0 (Fri Aug 02 2024)

- Update Foundations to Include All Components Dependent on the Library [#83](https://github.com/selsa-inube/inubekit-foundations/pull/83)
...
- Add GitHub Workflow to Automatically Update Foundations Dependencies [#82](https://github.com/selsa-inube/inubekit-foundations/pull/82)
...
- Update README.md in order to define the latest version on doc

---

# v5.2.3 (Fri Aug 02 2024)

- Update README.md in order to set new version
...
- feat(githubActions): update in order to include dispatch-update

---

# v5.2.0 (Thu Aug 01 2024)

- Update Tokens for Correct Value Usage [#81](https://github.com/selsa-inube/inubekit-foundations/pull/81)

---

# v5.1.0 (Mon Jul 08 2024)

- Update Typography Tokens to Remove Unnecessary Props Due to New Component Management [#80](https://github.com/selsa-inube/inubekit-foundations/pull/80)
...
- Update `<Table/>` Component Tokens [#79](https://github.com/selsa-inube/inubekit-foundations/pull/79)
...
- Include `<Table/>` Tokens [#78](https://github.com/selsa-inube/inubekit-foundations/pull/78)

---

# v3.2.0 (Mon Jun 17 2024)

- Update Color Token for Input [#77](https://github.com/selsa-inube/inubekit-foundations/pull/77)

---

# v3.1.0 (Tue Jun 11 2024)

- Update the reference token for the input component, in its focus state [#76](https://github.com/selsa-inube/inubekit-foundations/pull/76)
...
- Update foundations in order to include tokens for `<Divider/>` [#75](https://github.com/selsa-inube/inubekit-foundations/pull/75)

---

# v2.15.0 (Thu May 23 2024)

- Add Background Tokens for Expanded and Selected OptionList [#74](https://github.com/selsa-inube/inubekit-foundations/pull/74)
...
- Update input tokens structure [#73](https://github.com/selsa-inube/inubekit-foundations/pull/73)

---

# v2.13.0 (Tue Apr 30 2024)

- Update workflow in order to avoid merges with failed builds [#72](https://github.com/selsa-inube/inubekit-foundations/pull/72)
...
- Add auto publish [#71](https://github.com/selsa-inube/inubekit-foundations/pull/71)

#### 📝 Documentation

- Publish new version 2.12.0 [#70](https://github.com/selsa-inube/inubekit-foundations/pull/70)
...
- Publish new version 2.11.0 [#67](https://github.com/selsa-inube/inubekit-foundations/pull/67)

#### 🔩 Dependency Updates

- Update inubekit/foundations to storybook v8 [#68](https://github.com/selsa-inube/inubekit-foundations/pull/68)
...
- Publish new version 2.10.0 [#64](https://github.com/selsa-inube/inubekit-foundations/pull/64)
...
- Adjust border and contrast tokens for gray buttons [#63](https://github.com/selsa-inube/inubekit-foundations/pull/63)

#### 📝 Documentation

- Publish new version 2.9.0 [#62](https://github.com/selsa-inube/inubekit-foundations/pull/62)
...
- Publish new version 2.8.0 [#60](https://github.com/selsa-inube/inubekit-foundations/pull/60)
...
- FIx: adjust breadcrumbs tokens according to the file provided by the designer [#59](https://github.com/selsa-inube/inubekit-foundations/pull/59)

#### 📝 Documentation

- Publish new version 2.7.0 [#58](https://github.com/selsa-inube/inubekit-foundations/pull/58)
...
- Release new version 2.6.1 [#56](https://github.com/selsa-inube/inubekit-foundations/pull/56)
...
- Publish new version 2.6.0 [#54](https://github.com/selsa-inube/inubekit-foundations/pull/54)
...
- Publish new version 2.5.0 [#51](https://github.com/selsa-inube/inubekit-foundations/pull/51)
...
- Change contrast blocks in button tokens [#50](https://github.com/selsa-inube/inubekit-foundations/pull/50)
- Add gray appearance in spinner tokens [#49](https://github.com/selsa-inube/inubekit-foundations/pull/49)

#### 📝 Documentation

- Publish new version 2.4.0 [#48](https://github.com/selsa-inube/inubekit-foundations/pull/48)

---

# v2.4.0 (Thu Feb 29 2024)

- Create and export typography tokens [#47](https://github.com/selsa-inube/inubekit-foundations/pull/47)

#### 📝 Documentation

- Publish new version 2.3.0 [#46](https://github.com/selsa-inube/inubekit-foundations/pull/46)
...
- Update Button tokens [#44](https://github.com/selsa-inube/inubekit-foundations/pull/44)

#### 📝 Documentation

- Update package.json with the latest version according to CHANGELOG [#43](https://github.com/selsa-inube/inubekit-foundations/pull/43)
...
- Create new Button tokens [#38](https://github.com/selsa-inube/inubekit-foundations/pull/38)
- Create new Switch tokens [#37](https://github.com/selsa-inube/inubekit-foundations/pull/37)
...
- Adjust and publish Icon tokens [#35](https://github.com/selsa-inube/inubekit-foundations/pull/35)
...
- Create and export `<Fieldset />` tokens [#32](https://github.com/selsa-inube/inubekit-foundations/pull/32)

#### 🐛 Bug Fix

- Create and export `<Spinner />` tokens [#31](https://github.com/selsa-inube/inubekit-foundations/pull/31)
